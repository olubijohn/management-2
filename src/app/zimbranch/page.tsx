...
const branch = {
  ...
  DeviceModelName: "SunMI T2",
  DeviceModelVersion: "1.0",
  CertificateExpDate: "2025-08-07",
  ActivationKey: "AK-29384",
  DateCreated: "2025-08-07",
};
          ...
          <div className="flex-1 p-5 rounded-[10px] bg-white">
            ...
            <div className="space-y-3 text-sm">
              <div className="text-xs">
                <span className="font-semibold">Device Serial No</span>
                <span className="ml-2">{branch.deviceSerial}</span>
              </div>
              <div className="text-xs">
                <span className="font-semibold">Device Model Name</span>
                <span className="ml-2">{branch.DeviceModelName}</span>
              </div>
              <div className="text-xs">
                <span className="font-semibold">Device Model Version</span>
                <span className="ml-2 font-bold">
                  {branch.DeviceModelVersion}
                </span>
              </div>
              <div className="text-xs">
                <span className="font-semibold">Certificate Exp. Date</span>
                <span className="ml-2">{branch.CertificateExpDate}</span>
              </div>
              <div className="text-xs">
                <span className="font-semibold">Date Created</span>
                <span className="ml-2">{branch.dateCreated}</span>
              </div>
            </div>
          </div>
          {/* Activity Logs */}
